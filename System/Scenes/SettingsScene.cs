...
namespace GameJAM_Devtober2021.System.Scenes {
    public class SettingsScene : SceneBase {
        ...
        public SettingsScene(ConfigController config, ContentController content, InputController input, SceneController scene) : base("Settings") {
            _config = config;
            _content = content;
            _input = input;
            _scene = scene;
